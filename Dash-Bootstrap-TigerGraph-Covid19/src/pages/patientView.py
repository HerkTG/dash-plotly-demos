        ...
        dbc.Row(
            [
                    ...
                    html.Div(
                        [
                            dbc.Row(
                                dbc.InputGroup(
                                    [
                                        dbc.Input(id='input-group-button-input', placeholder='Enter Info'),
                                        dbc.InputGroupAddon(
                                            dbc.Button('Submit', id='input-group-button'),
                                            addon_type='append'
                                        ),
                                    ],
                                ),
                            ...
                            dbc.Row(
                                ...
                                style={'width': '100%', 'height': '150px', 'margin-bottom': '10px', "border-style": "solid"}
                            ),
                            dbc.Row(
                                html.Div(
                                    "Test",
                            ...
                            dbc.Row(
                                ...
                                style={'width': '100%', 'height': '375px', "border-style": "solid"}
                            ),
                        ],
                    ),
                    width=8,
                ...
                dbc.Col(
                    ...
                    width=4,
                    style={'width': '100%', 'height': '750px', "border-style": "solid"}
                ),
            ],
        ),
    ]
